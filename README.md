...
- Consulta de registros por colaborador
...
## Exemplo de Fluxo
1. Usuário realiza o registro de ponto
2. Sistema valida o horário informado
3. Dados são armazenados no banco
4. Registros podem ser consultados por período

## Como Executar
1. Clonar o repositório
2. Configurar ambiente PHP
3. Ajustar conexão com banco de dados
